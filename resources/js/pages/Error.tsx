...
export default function ErrorPage({ status }: ErrorProps) {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center bg-slate-50 p-6 text-center font-['Manrope',ui-sans-serif,system-ui,sans-serif] text-slate-900">
            ...
            <div className="mb-6 text-[4.5rem] leading-none font-extrabold tracking-tight text-[#1a4d2e] sm:text-[6rem]">
                {status}
            </div>
            ...
            <Link
                ...
                className="inline-flex items-center justify-center rounded-lg bg-[#1a4d2e] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#143d24] focus:ring-2 focus:ring-[#1a4d2e] focus:ring-offset-2 focus:outline-none"
            >
                {requiresLogin
